...
public class NoteListTest {
   ...
   * Test add notes
   */
  @Test public void testAddNotes() {
    INoteList testList = new NoteList();
    testList
      .addNotes(new Note(Pitch.C, new Octave(3), 0, 1), new Note(Pitch.C, new Octave(4), 0, 1));
   ...
   * Test add notes (List)
   */
  @Test public void testAddNotesList() {
    INoteList testList = new NoteList();
    List<INote> notes = Arrays
      .asList(new Note(Pitch.C, new Octave(3), 0, 1), new Note(Pitch.C, new Octave(4), 0, 1));
   ...
   */
  @Test public void testAddNotesDuplicates() {
    INoteList testList = new NoteList();
    List<INote> notes = Arrays
      .asList(new Note(Pitch.C, new Octave(3), 0, 1), new Note(Pitch.C, new Octave(4), 0, 1),
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testChangeANoteNotPresent() {
    INoteList testList = new NoteList();
   ...
   */
  @Test public void testChangeANote() {
    INoteList testList = new NoteList();
    List<INote> notes = Arrays
      .asList(new Note(Pitch.C, new Octave(3), 0, 1), new Note(Pitch.C, new Octave(4), 0, 1),
        new Note(Pitch.C, new Octave(4), 0, 1));
   ...
   */
  @Test public void testRemoveNote() {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testRemoveNoteNotPresent() {
    INoteList testList = testNormalListHelper();
    assertEquals(11, testList.getNotes().size());
    assertTrue(testList.member(new Note(Pitch.A, new Octave(4), 1, 2)));
    testList.removeNote(new Note(Pitch.A, new Octave(4), 1, 2));
   ...
   * Test member check
   */
  @Test public void testMemberTrue() {
    INoteList testList = testNormalListHelper();
    assertTrue(testList.member(new Note(Pitch.A, new Octave(4), 1, 2)));
  }
   ...
   */
  @Test public void testMemberTrueRef() {
    INoteList testList = testNormalListHelper();
   ...
   * Test member false
   */
  @Test public void testMemberFalseRef() {
    INoteList testList = testNormalListHelper();
    INote note = new Note(Pitch.GSHARP, new Octave(4), 1, 2);
   ...
   * Test member false
   */
  @Test public void testMemberFalse() {
    INoteList testList = testNormalListHelper();
   ...
   */
  @Test public void testMemberFalseWhenListEmpty() {
    INoteList testList = new NoteList();
