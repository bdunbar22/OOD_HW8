...
public class PitchTest {
    ...
    @Test
    public void testAll() {
        String allPitches = Pitch.C.toString() + Pitch.CSHARP.toString() + Pitch.D.toString()
                            + Pitch.DSHARP.toString() + Pitch.E.toString() + Pitch.F.toString()
                            + Pitch.FSHARP.toString() + Pitch.G.toString() + Pitch.GSHARP.toString()
                            + Pitch.A.toString() + Pitch.ASHARP.toString() + Pitch.B.toString();
