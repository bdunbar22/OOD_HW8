...
public class PitchAndOctaveComparatorTest {
     ...
     */
    @Test
    public void testStartingBeatNotImportant() {
     ...
     */
    @Test
    public void testDurationNotImportant() {
       INote note1 = new Note(Pitch.A, new Octave(4), 1, 5);
