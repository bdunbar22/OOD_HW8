...
public class NoteTest {
   ...
   */
  @Test public void testToString2Char() {
   ...
   */
  @Test public void testToString3Char() {
   ...
   */
  @Test public void testToString4Char() {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testNewNoteBeforeSong() {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testNewNoteNoDuration() {
   ...
   */
  @Test(expected = IllegalArgumentException.class) public void testNewNoteNegDuration() {
   ...
   */
  @Test public void testNewNoteBeforeSongMessage() {
    try {
      INote testNote = new Note(Pitch.GSHARP, new Octave(10), -1, 2);
   ...
   */
  @Test public void testNewNoteNoDurationMessage() {
    try {
      INote testNote = new Note(Pitch.GSHARP, new Octave(10), 0, 0);
    } catch (IllegalArgumentException exp) {
   ...
   */
  @Test public void testNewNoteNegDurationMessage() {
    try {
      INote testNote = new Note(Pitch.GSHARP, new Octave(10), 0, -1);
    } catch (IllegalArgumentException exp) {
      assertEquals("Error. Durations must be 1 beat or greater.", exp.getMessage());
   ...
   */
  @Test public void testIncrementWrap() {
   ...
   */
  @Test public void testOctaveGetter() {
   ...
   */
  @Test public void testEqualsSameRef() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testEqualsFalse1() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testEqualsFalse2() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testEqualsFalse3() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testEqualsFalse4() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testHashCodeSameRef() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
    INote testNote2 = testNote1;
    assertEquals(testNote1.hashCode(), testNote2.hashCode());
  }
   ...
   */
  @Test public void testHashCodeFalse1() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
    INote testNote2 = new Note(Pitch.D, new Octave(3), 1, 6);
   ...
   */
  @Test public void testHashCodeFalse2() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
    INote testNote2 = new Note(Pitch.C, new Octave(4), 1, 6);
    assertNotEquals(testNote1.hashCode(), testNote2.hashCode());
  }
   ...
   */
  @Test public void testHashCodeFalse3() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
    INote testNote2 = new Note(Pitch.C, new Octave(3), 2, 6);
    assertNotEquals(testNote1.hashCode(), testNote2.hashCode());
  }
   ...
   */
  @Test public void testHashCodeFalse4() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
    INote testNote2 = new Note(Pitch.C, new Octave(3), 1, 2);
    assertNotEquals(testNote1.hashCode(), testNote2.hashCode());
  }
   ...
   */
  @Test public void testIsStarting() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testIsStartingFalse() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testIsPersistent() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
   ...
   */
  @Test public void testIsPersistentFalse() {
    INote testNote1 = new Note(Pitch.C, new Octave(3), 1, 6);
    INote testNote2 = new Note(Pitch.D, new Octave(3), 1, 1);
    //Different pitch
